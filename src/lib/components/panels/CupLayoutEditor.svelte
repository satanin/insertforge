<script lang="ts">
  ...
  import { splitCup, deleteCup, updateSplitRatioByPath, countCups, getAllCupIds } from '$lib/types/cupLayout';
...
<div class="cupLayoutEditor">
  <div class="cupLayoutEditor__toolbar">
    ...
    <div class="cupLayoutEditor__toolbarButtons">
      ...
      <IconButton variant="ghost" onclick={handleDeleteCup} disabled={!canDelete} title="Delete selected cup">
